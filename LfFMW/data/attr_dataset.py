...
class AttributeDataset_bffhq(Dataset):
    def __init__(self, dataset, query_attr_idx=None, transform=None):
        super(AttributeDataset_bffhq, self).__init__()
        self.align = []
        self.conflict = []
        self.data = dataset.data
        self.transform = transform
        self.attr = torch.LongTensor(dataset.attr)
