...
class attention_module(nn.Module):
    def __init__(self, input_features, output_features):
        ...
        self.K = nn.Linear(input_features, output_features)
    ...
    def forward(self,image_features, mem_features):
        ...
        attention = torch.matmul(attention_scores, mem_features)
...
class AttentionLayer(nn.Module):
    ...
    def __init__(self, encoder_output_dim:int, output_dim:int, head: torch.nn.Module=None, classifier:torch.nn.Module=None,distance:str='cosine'):
        ...
        self.attention_block = attention_module(encoder_output_dim,encoder_output_dim)
    ...
    def forward(self, encoder_output:torch.Tensor, memory_set:torch.Tensor, return_weights = False)->torch.Tensor:
        ...
        memory_vector, content_weights = self.attention_block(encoder_output,memory_set)
